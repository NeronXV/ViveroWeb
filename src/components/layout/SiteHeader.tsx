...
export function SiteHeader({ onOpenCart }: { onOpenCart: () => void }) {
  const { cartCount, darkTheme, toggleTheme } = useDemoStore()
  return (
    <header>
      <div className="nav-container">
        ...
        <div className="nav-actions">
          ...
          <button className="cart-toggle-btn" onClick={onOpenCart} aria-label={`Ver carrito, ${cartCount} artículos`}>🛒<span className="cart-count">{cartCount}</span></button>
