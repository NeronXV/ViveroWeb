...
export const heroImage = fotoPrincipal
export const initialPlants: Plant[] = [
  ...
  { id: 7, name: 'Buganvilla de Verano', category: 'exterior', price: 45.99, light: 'alta', water: 'alta', pets: false, image: fotoPrincipal, lightDesc: 'Sol directo pleno', waterDesc: 'Riego regular', petDesc: 'Tóxica para mascotas', description: 'Enredadera espectacular con abundantes flores. Llena de vida terrazas y patios.', stock: 7, discount: 0 },
